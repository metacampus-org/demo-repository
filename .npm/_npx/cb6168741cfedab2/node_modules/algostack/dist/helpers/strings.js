...
// Integers
export function isIntegers(str) {
    return /^\d+$/.test(str);
}
...
export function isAssetId(str) {
    return /^\d{1,14}$/.test(str);
}
export function isAppId(str) {
    return /^\d{1,14}$/.test(str);
}
...
export function isTransaction(str) {
...
export function isDomainUrl(str) {
    return domainPattern.test(str);
}
// check for ipfs protocol
export function isIpfsProtocol(url) {
    return /^ipfs:\/\//.test(url);
}
// check for ipfs subdomain
export function isIpfsSubdomain(url) {
...
export function isImageFileUrl(str) {
    return isUrl(str) && imageUrlPattern.test(str);
}
export function isVideoFileUrl(str) {
    return isUrl(str) && videoUrlPattern.test(str);
}
export function isAudioFileUrl(str) {
    return isUrl(str) && audioUrlPattern.test(str);
}
export function isMediaFileUrl(str) {
