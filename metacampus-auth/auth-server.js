...
const CALLBACK_URL = 'https://dev.metacampus.org/auth/google/callback';
  ...
  res.send(`
	...
	<body>
	  <div class="header">
            ...
            <div style="margin-left: auto; background: #d97706; color: white; padding: 0.25rem 0.75rem; border-radius: 6px; font-size: 0.8rem; font-weight: 600;">DEV</div>
          </div>
